...
# si se pasa del rango puedo ver si si lo pinta o no
    ...
    def Matrizderotacion(self, rotacion=(0, 0, 0)):

        # funcion radianes en LibreriaGL
        # muevo roto scalo
        pitch = radianes(rotacion[0])
        yaw = radianes(rotacion[1])
        roll = radianes(rotacion[2])
        ...
        xyroot = productomatriz(rotationX, rotationY)
        xyzroot = productomatriz(xyroot, rotationZ)
